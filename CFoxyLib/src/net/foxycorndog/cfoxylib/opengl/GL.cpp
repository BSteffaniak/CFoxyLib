...
void GL::popMatrix()
{
	...
	delete[] amountScaled.pop();
	delete[] amountTranslated.pop();
	delete[] amountRotated.pop();
	delete[] currentLocation.pop();
}
...
/**
 * Delete all of the pointers to the data in the Stacks that keep
 * track of the matrix.
 */
void GL::deleteMatrixStacks()
{
	while (!amountScaled.isEmpty())
	{
		delete[] amountScaled.pop();
		delete[] amountTranslated.pop();
		delete[] currentLocation.pop();
